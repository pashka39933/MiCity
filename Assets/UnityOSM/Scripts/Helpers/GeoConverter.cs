...
namespace Assets.Helpers
{
    public static class GM
    {
        ...
        public static Rect TileBounds(Vector2 t, int zoom)
        {
            ...
            return new Rect(Mathf.RoundToInt(min.x), Mathf.RoundToInt(min.y), Mathf.RoundToInt(max.x - min.x), Mathf.RoundToInt(max.y - min.y));
        }
        ...
        public static Vector2 LonLatToMercator(double lon, double lat, int zoom)
        {
